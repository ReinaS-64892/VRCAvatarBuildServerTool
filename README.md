...
非常にセットアップが煩雑ですが頑張ってください。(旧版の Editor を直接 Server にする機能のことに使用したことのある人であればほぼ同じ概念が多いので簡単にわかると思います。)
...
もっとも、そのような、不自由なツールが、ローカルでの編集を許容していることは(なくはないですが)珍しいく、プロジェクトを複数に分けるような人は導入に手間がかかるようになるので、捨てたほうが幸せだと私は思います。
